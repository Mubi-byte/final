    ...
    try:
        ...
        if file_ext in ('docx', 'doc'):
            ...
            if not pdf_path:
                return JSONResponse(
                    status_code=400,
                    content={"message": "Failed to convert Word document to PDF"}
                )
        ...
        # Handle direct PDF uploads
            ...
            return JSONResponse(
                status_code=400,
                content={"message": "Only PDF and Word documents are allowed"}
            )
        ...
        return {"message": "File uploaded and processed successfully.", "success": True}

    except Exception as e:
        return {"message": f"Processing failed: {str(e)}", "success": False}
